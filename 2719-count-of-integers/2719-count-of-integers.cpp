...
public:
    int count(string num1, string num2, int min_sum, int max_sum) {
        ...
        int lro= num2.length() - num1.length();
        string num1ex = string(lro,'0')+num1;
        int total = countStrings(0, 1, 1, max_sum, num1ex, num2);
        int unnecessary = countStrings(0, 1, 1, min_sum - 1,num1ex,num2);
